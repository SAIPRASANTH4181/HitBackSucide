...
class aspect_based_analysis:
    ''' 
    Class for aspect based analysis. It takes the preprocessed data and perform the aspect based sentiment analysis.
    ''' 
    ...
    def aspect_based_analysis(self,toy_rev):
        '''
        toy_rev     : the cleaned data after preprocessing 
        return      : the dataframe with the aspect based compound sentiment scores and aspect words. 
                      In aspect analysis the list of emotions are given for comparision. It uses the vader sentiment analyer. 
        '''
